package com.study.test.orm.support;
...
public class EntitySupport<T> {
    ...
    private Logger log = Logger.getLogger(EntitySupport.class);
    ...
    public EntitySupport(Class<T> clazz, String pk) throws Exception{
